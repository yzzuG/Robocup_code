...
int main() {
	...
	while (stop == 0)
	{
		...
		else if (data_id == stop_data)			//security : stop robot
		{
			data_id = vel_data;
			successFlag=com.WriteChar(data_id);
			successFlag=com.WriteChar(0x01);
			successFlag=com.WriteChar(0x04);	// send 0% 
		}
		/***************************************************************************************************/
	...
	/***************************************************************************************************/
	successFlag=com.WriteChar(dir_data);
	successFlag=com.WriteChar(0x01);
	successFlag=com.WriteChar(0x04);	// send 0% 

	usleep(100000);

	successFlag=com.WriteChar(vel_data);
	successFlag=com.WriteChar(0x01);
	successFlag=com.WriteChar(0x04);	// send 0% 
	/***************************************************************************************************/
